...
/* with arrays and vectors, it is very hard to insert a
/ space in memory, in the middle of the vector or array, Link
/ list allows us to do this. (we  use nodes) We will have  a
/ head pointer in runtime stack, pointing at the other nodes in
/ heap. link lists however are harder to access.
*/
